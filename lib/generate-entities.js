function GenerateEntities(argv, EntitiesParser, generatorBuilder, appRoot) {
    ...
    function liftoffCallback(environment) {
        ...
        var entitiesFileParser = new EntitiesFileParser(entitiesfile, generatorBuilder, appRoot);
